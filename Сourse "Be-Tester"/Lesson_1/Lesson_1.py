...
# 2) Написать программу, где на ввод с клавиатуры подаются два числа X и Y, после чего,
# на экране должна отобразиться сумма этих чисел.
...
# 4) Написать программу, где на ввод с клавиатуры подаются буквы и цифры X и Y, после чего,
# на экране должны отобразиться данные с пробелом.
x = input()  # input() считывает данные с клавиатуры и присваивает их в переменную
y = input()
print(x, y)

# 5) Написать программу, где на ввод с клавиатуры подаются любые значения X и Y, после чего,
# на экране должна отобразиться сумма длины этих значений.
x = input()
y = input()
print(len(x + y))

# 6) Написать программу, которая объединяет первую и вторую строку и умножает их на N раз.
# Перед вводом значения, должно отображаться сообщение-подсказка.
...
# 8) Написать программу, где на ввод с клавиатуры подаются любые числовые значения,
# а на выводе отображается True или False в зависимости от того, больше первое число второго или нет.
x = int(input("Введите первое число: "))
y = int(input("Введите второе число: "))
print(x > y)

# 9) Написать программу, где на ввод с клавиатуры, поочерёдно подаются целые числа X и Y.
# Если их сумма больше 10, тогда должно возникнуть сообщение "Сумма больше 10", если сумма меньше 10,
# тогда должно возникнуть сообщение "Сумма меньше 10", при равенстве, возкникнет сообщение "Сумма равна 10".
...
# 10) Написать программу, где нужно ввести целое число. Если оно положительное, тогда на экран выводится
# цифра 1. Если число отрицительное, выводится -1. Если число - это 0, то на экран выводится 0.
...
# 11) Написать программу, где на ввод с клавиатуры, поочерёдно подаются целые числа X и Y.
# На экран необходимо вывести минимальное значение из двух чисел. Если значения чисел совпадают,
# то нужно вывести сообщение: "Числа совпадают".
x = int(input("Введите первое число: "))
y = int(input("Введите второе число: "))
if x > y:
    print(y)
...
# 12) Написать программу, которая спрашивает у пользователя 3 вопроса: его имя, профессию и возраст.
...
# 14) Программа принимает 3 целых числа. Нужно определить какое из них является максимальным и вывести его на экран.
...
# 15) Программа принимает 3 целых числа. Нужно определить какое из них является средним и вывести его на экран.
# У всех трёх чисел должны быть разные значения.
a = int(input("Введите первое число: "))
b = int(input("Введите второе число: "))
c = int(input("Введите третье число: "))
...
# 17) Написать программу которая будет определять, достаточно ли у пользователя денег для покупки товаров.
# На вход принимается целое число (количество денег пользователя) с сообщением подсказкой: "Сколько у Вас
# денег?". Далее, нужно определить хватит ли денег на покупку всех товаров.
# Если пользователю нужна сдача, тогда на экран нужно вывести общую стоимость товаров и далее отдельно строкой –
# сумму его сдачи. Если сдача ненужна, тогда нужно вывести сообщение: "Спасибо, что без сдачи!".
...
# Если Маша бегает менее X метров, выведите "Слишком мало бегаете", если же более Y метров,
# то выведите "Много бегать вредно".
